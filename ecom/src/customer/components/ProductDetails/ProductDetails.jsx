  ...
  return (
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-0 gap-y-10 px-4 pt-10'>
            {/* Image gallery */}
            ...
            <div className="border p-5">
                <Grid container spacing={7}>
                    ...
                    <Grid item xs={5}>
                        ...
                        <div className=''>
                            <div className='flex items-center space-x-3'>
                                <Rating value={3.2} readOnly precision={.5}></Rating>
                                <p className='opacity-60'>59484 Ratings</p>
                            </div>
                            <Stack spacing={2} className="mt-5">
                              <Box display="flex" alignItems="center" gap={2} flexWrap="wrap">
                                <p style={{ minWidth: 80 }}>Excellent</p>
                                <LinearProgress
                                  variant="determinate"
                                  value={50}
                                  color='success'
                                  sx={{
                                    flexGrow: 1, // <-- makes the bar take remaining space
                                    bgcolor: "#d0d0d0",
                                    borderRadius: 4,
                                    height: 7,
                                    width:"300px"
